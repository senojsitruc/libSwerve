...
public struct CJHttpServerHandlerMatch {
	public let handler: CJHttpServerRequestHandler
	public var request: CJHttpServerRequest
	public let response: CJHttpServerResponse
...
public typealias CJHttpServerRequestHandler = (CJHttpServerHandlerMatch) -> Void
...
//var query: [String: String]()
	...
	var contentHandler: ((AnyObject?, Bool) -> Void)? { get set }
	
	init(methodName: String, path: String, version: String, connection: CJHttpConnection?, completionHandler: (() -> Void)?)
...
public extension CJHttpServerRequest {
...
public protocol CJHttpServer {
	...
	mutating func addHandler(method: CJHttpMethod, pathEquals: String, waitForData: Bool, handler: CJHttpServerRequestHandler)
	mutating func addHandler(method: CJHttpMethod, pathLike: String, waitForData: Bool, handler: CJHttpServerRequestHandler)
